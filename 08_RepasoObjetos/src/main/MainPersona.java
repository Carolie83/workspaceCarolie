...
public class MainPersona {
	...
	Persona p2 = new Persona("Terence Hill", 67, 70);
		...
		p2 = pAux; //tras esto Terence Hill desaparece ya no hay referencias a él y lo eliminará el colector de basura
		int numero = 50;
		...
		/*	listaPersonas.add(p3); tambien se podría poner aquíy el resultado será el mismo
		...
		p3.setEdad(19);
		p3.setPeso(56);
		listaPersonas.add(p3);//la función add, añade en la primera posición libre del arrary dicho objeto
