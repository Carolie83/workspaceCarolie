...
public class MainColecciones {
	...
	public static void main(String[] args) {
		...
		System.out.println(listaNombres.get(3));// devuelve posición 3 Ofelia
		...
		int i = 5;// aquí se trabaja con el 5 como primitivo
		Integer entero = new Integer(4); // aquí trabajamos con 4 como objeto
		 ...
		 * el colector de basura no elimina el objeto hasta que no tenga ninguna referencia al objeto para acceder a él,
		 *  en ese momento ya lo eliminará cuando pase, p2 sigue apuntando a ella. Se podría borrar tambien por referencia*/
		// listaPersonas.remove(1); eliminar de lista por clave
		listaPersonas.remove(p2);
		System.out.println(listaPersonas);
		// no podemos acceder a una posición que no exísta
		...
		System.out.println(mapaUsuarioContrasenia.get("Felix")); // está pensado para acceder por la clave
		...
		/*estructura clave valor no puede haber 2 claves iguales, lo que hará es reecribir una nueva pasword en Pepe */
