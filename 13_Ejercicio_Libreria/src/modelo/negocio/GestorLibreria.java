...
//Esta parte del modelo se encargaría de realizar
	...
	public class GestorLibreria {
		...
		public boolean alta(Libro l) {
			...
			if(l.getIsbn().isEmpty()) {//si ISBN esta vacio devuelve false
				return false;
			}
			
			if(l.getTitulo().isEmpty()) {//si titulo esta vacio devuelve false
				return false;
			}
			...
			listaLibros.add(l);//add un libro a la vista
			return true;
		}
		/**
