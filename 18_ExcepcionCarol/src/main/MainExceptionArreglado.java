...
import java.util.Scanner;
		public class MainExceptionArreglado {
			public static void main(String[] args) {
				...
				//Este bloque de aquí, sera la parte que va a intentar java ejecutar.si ocurriera, en vez de parar el programa entraría por la parte cath
		...
		do {
			try {
				...
				//en la variable ae, tenenmos información A cerca del error que se ha producido y podemos mostrarla o no,segun nuestro criterio
