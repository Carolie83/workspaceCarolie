...
@Configuration
//Le decimos a spring que vamso a trabajar con un repositorio jpa que esta en el sigiente paquete
@EnableJpaRepositories(basePackages= {"curso.modelo.persistencia"})
//le decimos a spring donde tiene que ir a buscar objetos para dar de alta
...
public class Configuracion {
	...
	public DataSource dataSource() {
		...
		ds.setUrl("jdbc:mysql://localhost:3306/usuarios_spring?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
		ds.setUsername("root");
		ds.setPassword("root");
		return ds;
	}
